...
RENDISTR = [
    "`I Know Uh ez Rendi Bhay Don't show Your Randi Pesa Here`",
...
NOOBSTR = [
    "`YOU PRO NIMBA DON'T MESS WIDH MEH`",
    ...
    "`UH DON'T KNOW MEH SO STAY AWAY LAWDE`",
