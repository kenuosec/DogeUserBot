        ...
        try:
            ...
            if "(" not in downloaded_file_name:
                ...
                try:
                    ...
                    return edl(
                        event,
                        f"`Error: Module not found error.`\n\nTry to write `{tr}finstall` & reply.",
                        15,
                    )
                ...
                await edl(
                    ...
                    \n\n\
                    ✨ If you want to learn about {path.basename(downloaded_file_name)} you have installed, write:**\
                    \n\n\
                    `{tr}doge {path.basename(downloaded_file_name)}`.",
                    90,
                )
            else:
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            if "(" not in downloaded_file_name:
                ...
                await edl(
                    event,
                    f"**🔮 Plugin force installed {path.basename(downloaded_file_name)} successfully!\
                    \n\n\
                    ✨ If you want to learn about {path.basename(downloaded_file_name)} you have installed, write:**\
                    \n\n\
                    `{tr}doge {path.basename(downloaded_file_name)}`.",
